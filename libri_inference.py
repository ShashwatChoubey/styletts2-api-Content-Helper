...
if __name__ == "__main__":
    ...
    synthesier = STYLETTS2_Inference(
        config_path="C:/Users/shash/OneDrive/Desktop/ElevenLabs Clone/StyleTTS2/Models/config.yml",
        model_path="C:/Users/shash/OneDrive/Desktop/ElevenLabs Clone/StyleTTS2/Models/epochs_2nd_00020.pth"
    )

    style = synthesier.compute_style("C:/Users/shash/OneDrive/Desktop/ElevenLabs Clone/StyleTTS2/Models/anger.wav")

    audio = synthesier.inference(text="Shashwat is far behind in life.He will always be a big loser",ref_s=style,)
